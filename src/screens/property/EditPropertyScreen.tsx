...
export default function EditPropertyScreen() {
  ...
  useEffect(() => {
    if (property) {
      ...
      setTotalUnits(String(property.total_units || 1));
  ...
  if (!property) {
    return (
      <View style={styles.container}>
        <Text style={styles.errorTextCentered}>Property not found</Text>
      </View>
    );
  }
    ...
    >
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.form}>
          ...
          <TouchableOpacity
            style={[styles.submitButton, updateProperty.isPending && styles.submitButtonDisabled]}
